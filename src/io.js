...
import { state, markExported, dirtyCount } from './state.js?v=20260726a';
import { packBundle, unpackBundle, bundleFileName } from './serialize.js?v=20260726a';
import { nfc } from './parse.js?v=20260726a';
