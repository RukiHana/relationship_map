...
import { state, markExported, dirtyCount } from './state.js?v=20260727a';
import { packBundle, unpackBundle, bundleFileName } from './serialize.js?v=20260727a';
import { nfc } from './parse.js?v=20260727a';
