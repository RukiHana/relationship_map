...
import { state, markExported, dirtyCount } from './state.js?v=20260726b';
import { packBundle, unpackBundle, bundleFileName } from './serialize.js?v=20260726b';
import { nfc } from './parse.js?v=20260726b';
