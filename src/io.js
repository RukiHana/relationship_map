...
import { state, markExported, dirtyCount } from './state.js?v=20260726f';
import { packBundle, unpackBundle, bundleFileName } from './serialize.js?v=20260726f';
import { nfc } from './parse.js?v=20260726f';
