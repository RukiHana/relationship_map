...
import { vocabulary, adjacency, byId } from './state.js?v=20260727a';
import { groupByCategory, suggestPair } from './roles.js?v=20260727a';
import { norm, matchesQuery } from './parse.js?v=20260727a';
