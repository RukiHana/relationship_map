...
import { vocabulary, adjacency, byId } from './state.js?v=20260726c';
import { groupByCategory, suggestPair } from './roles.js?v=20260726c';
import { norm } from './parse.js?v=20260726c';
