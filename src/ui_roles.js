...
import { vocabulary, adjacency, byId } from './state.js?v=20260726j';
import { groupByCategory, suggestPair } from './roles.js?v=20260726j';
import { norm, matchesQuery } from './parse.js?v=20260726j';
